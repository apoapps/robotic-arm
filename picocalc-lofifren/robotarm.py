...
header,footer{{padding:8px 10px;border-bottom:2px solid #000}}footer{{border-top:2px solid #000;border-bottom:0;font-size:11px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}}
main{{min-height:0;overflow:hidden;padding:8px;display:grid;grid-template-rows:auto auto 1fr auto;gap:8px}}
...
.grid{{min-height:0;display:grid;grid-template-columns:1fr 1fr;grid-template-rows:1fr 1fr;gap:8px}}.axis{{min-height:0;border:2px solid #000;padding:7px;display:grid;grid-template-columns:54px 1fr;grid-template-rows:auto 1fr;gap:6px;align-items:center}}
.axis .pair{{grid-column:1/3;align-self:end}}.axis strong{{float:right;font-size:17px}}.axis b{{display:block;font-size:13px;line-height:1.05}}.axis span{{font-size:11px}}.axis em{{display:block;font-style:normal;font-size:10px;line-height:1.1}}.pick{{padding:5px;min-height:44px;flex-direction:column;gap:1px;font-size:11px}}.selected{{background:#000;color:#fff;outline:2px solid #000;outline-offset:1px}}.selected button{{border-color:#fff}}
.moves,.pair{{display:grid;grid-template-columns:1fr 1fr;gap:6px;margin:0}}.moves button{{font-size:16px;min-height:48px}}.pair .jog{{font-size:12px;min-height:46px;padding:6px 4px}}.pair .jog .ion{{width:18px;height:18px}}.hero{{border:3px solid #000;padding:8px;text-align:center;background:#fff;color:#000}}.hero .small{{font-size:11px;text-transform:uppercase}}.hero .big{{font-size:20px;font-weight:900;margin-top:2px}}.moving{{background:#000;color:#fff}}.moving .big{{font-size:23px}}.activeMove{{background:#000!important;color:#fff!important}}.panic{{width:70px;height:70px;border-radius:999px;background:#c00;color:#fff;border:4px solid #000;margin:0 auto;font-size:12px;flex-direction:column}}.panic:active{{background:#900;color:#fff}}.meta{{display:none}}
@media (max-height:620px){{.sub,footer{{display:none}}main{{gap:6px;padding:6px}}.hero{{padding:5px}}.hero .big{{font-size:18px}}.axis{{padding:5px;gap:4px}}.pair .jog{{min-height:38px;font-size:11px}}.panic{{width:58px;height:58px}}}}
</style></head><body>
